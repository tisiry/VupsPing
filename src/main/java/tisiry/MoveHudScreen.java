...
public class MoveHudScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        context.fillGradient(0, 0, this.width, this.height, 0x1F101010, 0x3F101010);
    ...
    // ИСПРАВЛЕНО: Проблемный метод mouseScrolled полностью удален, чтобы избежать ошибок маппингов Loom.
    // Изменение масштаба HUD теперь полностью и стабильно работает через клавиши W и S.
